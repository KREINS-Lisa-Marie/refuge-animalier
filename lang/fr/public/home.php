...
return [
    ...
    'page_description' => 'Ici nous soignons et donnent de l’espoir aux animaux abandonnés ou maltraités de la région de Malmedy et ses environs.',
    'adopt_us'=>'Adoptez-nous',
    'need_more_info'=>'Besoin de plus d’infos?',
    'need_more_info_description'=>' Si vous avez besoin de plus d’informations sur le processus d’adoption, votre demande d’adoption en cours, si vous voulez devenir bénévole ou si vous avez besoin de plus d’informations générales, contactez-nous via notre formulaire de contact',
