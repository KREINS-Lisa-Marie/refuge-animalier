    ...
    <form wire:submit="save" class="profile-form volunteers-edit">
        ...
        <fieldset class="profile-information max-w-admin-web  edit-inputs ">
            ...
            <div class="profile-information">
                <x-fields.text id="adoptant-last-name" name="adoptant-last-name" placeholder="Ex: John" wire="last_name"
                               value="{!! $request->last_name !!}">
                    {{__('admin/adoption-requests.adoptant_last_name')}}
                </x-fields.text>
                <x-fields.text id="first_name" name="adoptant-first-name" placeholder="Ex: John" wire="first_name"
                               value="{!! $request->first_name !!}">
                    {{__('admin/adoption-requests.adoptant_first_name')}}
                </x-fields.text>
                <x-fields.text id="address" name="address" placeholder="Ex: Rue de l’école 3, 4000 Liège"
                               wire="address">
                    {{__('admin/adoption-requests.adress')}}
                </x-fields.text>
                <x-fields.phone wire="phone" name="adoptant-phone" id="adoptant-phone" placeholder="038948927"
                                value="{!! $request->phone !!}">
                ...
                <x-fields.textarea wire="message" id="adoption-message" name="message"
        ...
        <fieldset class="profile-information max-w-admin-web  edit-inputs ">
            <x-fields.textarea wire="comment" id="adoption-comment" name="adoption-comment" placeholder="{{__('admin/adoption-requests.placeholder_comment')}}" >
