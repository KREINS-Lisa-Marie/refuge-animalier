...
class AdoptionRequestCreatedMail extends Mailable implements ShouldQueue
{
    ...
    public function envelope(): Envelope
    {
        return new Envelope(
            ...
            subject: __('emails/adoption-request-created.adoption-request-created'),
        );
    }
    ...
    {
        return new Content(
            view: 'emails.adoption-request-created',
        );
    }
